    ...
    return (
        <>
            ...
            <Menu autoSelect={false}>
                ...
                <MenuList>
                    <Link to="/series?sort=popularity_desc">
                        <MenuItem>Popular</MenuItem>
                    </Link>
                    <Link to="/series?sort=rating_desc">
                        <MenuItem>Top Rated</MenuItem>
                    </Link>
                    <Link to="/series/home">
                        <MenuItem>Home</MenuItem>
                    </Link>
                    <Link to="/series/watchlist">
                        <MenuItem>Watchlist</MenuItem>
                    </Link>
                    <Link to="/series/favorites">
                        <MenuItem>Favorites</MenuItem>
                    </Link>
                    <Link to="/series/watched">
                        <MenuItem>Watched</MenuItem>
                    </Link>
                    <Link to="/series/countdown">
                        <MenuItem>Countdown</MenuItem>
                    </Link>
                    <Link to="/series/recently-aired">
                        <MenuItem>Recently aired</MenuItem>
                    </Link>
                    <Link to="/series/to-watch">
            ...
            <Menu autoSelect={false}>
                ...
                <MenuList>
                    <Link to="/movies?sort=popularity_desc">
                        <MenuItem>Popular</MenuItem>
                    </Link>
                    <Link to="/movies?sort=rating_desc">
                        <MenuItem>Top Rated</MenuItem>
                    </Link>
