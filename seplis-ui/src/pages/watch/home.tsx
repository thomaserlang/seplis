...
import { ISeries, ISeriesAndEpisode } from '@/interfaces/series'
import { IUserWatched } from '@/interfaces/user_watched'
...
export default function WatchHome() {
    ...
    const userWatchedSelected = useCallback((item: IUserWatched) => {
        if (item.type == 'series') seriesSelected(item.data as ISeries)
        else if (item.type == 'movie') movieSelected(item.data as IMovie)
    }, [])
