...
@router.get('/{play_server_id}/user-series-following-missing-episodes', response_model=schemas.Page_cursor_result[schemas.Series])
async def get_play_server_series_following_missing_episodes(
    play_server_id: str,
